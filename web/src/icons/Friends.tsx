...
export default function SvgSolidFriends(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width={22}
      height={16}
      ...
      {...props}
    >
      <g clipPath="url(#sm-solid-friends_svg__clip0)" fill={props.fill}>
      ...
      <defs>
        <clipPath id="sm-solid-friends_svg__clip0">
          <path fill={props.fill} d="M0 0h21.6v16H0z" />
        </clipPath>
      </defs>
    </svg>
  );
